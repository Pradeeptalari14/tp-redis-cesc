# 🔧 Troubleshooting Guide — Redis-CESC
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-redis-cesc/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/redis-cesc/)
